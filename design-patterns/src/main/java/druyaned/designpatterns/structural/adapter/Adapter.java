package druyaned.designpatterns.structural.adapter;

import druyaned.designpatterns.structural.adapter.src.RoundHole;
import druyaned.designpatterns.structural.adapter.src.RoundPeg;
import druyaned.designpatterns.structural.adapter.src.SquarePeg;
import druyaned.designpatterns.structural.adapter.src.SquareToRoundPeg;
