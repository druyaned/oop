package druyaned.designpatterns.behavioral.iterator;

import druyaned.designpatterns.behavioral.iterator.src.List;
...
public class Iterator {
    ...
    public static void main(String[] args) {
        ...
        druyaned.designpatterns.behavioral.iterator.src.Iterator<Integer>
                iter = list.iterator();
